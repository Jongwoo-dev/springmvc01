...
public class Control07 {
   ...
   * => 기본은 필수입력ㄱ이다. 파라미터에 해당 이름의 값이 없으면 예외가 발생한다.
   */
  ...
  public void test04(
      ...
      @RequestParam(value="age", required=false) int age, /* 프론트 컨트롤러가 문자열을 자바 원시 타입으로 자동 변환해 준다 */
  ...
  public void test05(
      @RequestParam(value="name", required=false) String name, 
      @RequestParam(value="age", defaultValue="0") int age, /* 프론트 컨트롤러가 문자열을 자바 원시 타입으로 자동 변환해 준다 */
  ...
  public void test06(
      ...
      @RequestParam(defaultValue="0") int age, /* 프론트 컨트롤러가 문자열을 자바 원시 타입으로 자동 변환해 준다 */
